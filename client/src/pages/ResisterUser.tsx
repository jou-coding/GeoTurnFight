            ...
            <div className="w-full max-w-md transform translate-y-6 sm:translate-y-8 bg-blue-500">
                <div className="bg-white shadow-lg rounded-2xl p-6 sm:p-8">
                    ...
                    <form className="space-y-4">
                        ...
                        <button type="button" className="w-full  bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition">送信</button>
                    </form>
                    <p className="text-center test-sm text-gray-500 mt-4">アカウントがありませんか？
                        <a href="#" className="text-blue-500 hover:underline">新規登録</a>
                    </p>
                </div>
            </div>
